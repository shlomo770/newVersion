...
// node_modules/@hyvilo/maplibre-gl-draw/dist/maplibre-gl-draw.js
var require_maplibre_gl_draw = __commonJS({
  "node_modules/@hyvilo/maplibre-gl-draw/dist/maplibre-gl-draw.js"(exports, module) {
    !function(t, e) {
      "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).MapLibreDraw = e();
    }(exports, function() {
      "use strict";
      ...
      var D = e(w.exports), k = function(t2, e2) {
        this.ctx = t2, this.properties = e2.properties || {}, this.coordinates = e2.geometry.coordinates, this.id = e2.id || D(), this.type = e2.geometry.type;
      };
      k.prototype.changed = function() {
        this.ctx.store.featureChanged(this.id);
      }, k.prototype.incomingCoords = function(t2) {
        this.setCoordinates(t2);
      }, k.prototype.setCoordinates = function(t2) {
        this.coordinates = t2, this.changed();
      }, k.prototype.getCoordinates = function() {
        return JSON.parse(JSON.stringify(this.coordinates));
      }, k.prototype.setProperty = function(t2, e2) {
        this.properties[t2] = e2;
      }, k.prototype.toGeoJSON = function() {
      ...
      }, k.prototype.internal = function(t2) {
      ...
      (U.prototype = Object.create(k.prototype)).isValid = function() {
      ...
      (j.prototype = Object.create(k.prototype)).isValid = function() {
      ...
      var V = function(t2, e2) {
        k.call(this, t2, e2), this.coordinates = this.coordinates.map(function(t3) {
          return t3.slice(0, -1);
        });
      };
      (V.prototype = Object.create(k.prototype)).isValid = function() {
      ...
      var B = { MultiPoint: U, MultiLineString: j, MultiPolygon: V }, G = function(t2, e2, n2, o2, r2) {
        ...
        if (k.call(this, t2, e2), delete this.coordinates, this.model = B[e2.geometry.type], void 0 === this.model)
      ...
      (J.prototype = Object.create(k.prototype))._coordinatesToFeatures = function(t2) {
        var e2 = this, n2 = this.model.bind(this);
        return t2.map(function(t3) {
          return new n2(e2.ctx, { id: D(), type: f.FEATURE, properties: {}, geometry: { coordinates: t3, type: e2.type.replace("Multi", "") } });
        });
        ...
        var n2 = null, o2 = null, r2 = { onRemove: function() {
          ...
          return i2.fire = function(t2, e3) {
            ...
            i3.drag = function(t2, n4) {
              ...
              if (t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent && t2.originalEvent.cancelable && t2.originalEvent.preventDefault(), e3.options.touchEnabled) {
            ...
            i3.keydown = function(t2) {
              (t2.srcElement || t2.target).classList.contains("maplibregl-canvas") && (8 !== t2.keyCode && 46 !== t2.keyCode || !e3.options.controls.trash ? u2(t2.keyCode) ? s2.keydown(t2) : 49 === t2.keyCode && e3.options.controls.point ? c2(h.DRAW_POINT) : 50 === t2.keyCode && e3.options.controls.line_string ? c2(h.DRAW_LINE_STRING) : 51 === t2.keyCode && e3.options.controls.polygon && c2(h.DRAW_POLYGON) : (t2.preventDefault(), s2.trash()));
        ...
        return function t3(a2) {
          ...
          function d2() {
            if ("object" == typeof l2.node && null !== l2.node) {
              l2.keys && l2.node_ === l2.node || (l2.keys = Dt(l2.node)), l2.isLeaf = 0 == l2.keys.length;
      ...
      function Rt(t2) {
        if ("object" == typeof t2 && null !== t2) {
          ...
          if (Ut(t2))
            e2 = [];
          else if ("[object Date]" === kt(t2))
            e2 = new Date(t2.getTime ? t2.getTime() : t2);
          else if (function(t3) {
            return "[object RegExp]" === kt(t3);
          }(t2))
            e2 = new RegExp(t2);
          else if (function(t3) {
            return "[object Error]" === kt(t3);
          }(t2))
            e2 = { message: t2.message };
          else if (function(t3) {
            return "[object Boolean]" === kt(t3);
          }(t2))
            e2 = new Boolean(t2);
          else if (function(t3) {
            return "[object Number]" === kt(t3);
          }(t2))
            e2 = new Number(t2);
          else if (function(t3) {
            return "[object String]" === kt(t3);
          }(t2))
            e2 = new String(t2);
      ...
      Ft.prototype.get = function(t2) {
        ...
        return function n2(o2) {
          ...
          if ("object" == typeof o2 && null !== o2) {
            var i2 = Rt(o2);
            return t2.push(o2), e2.push(i2), jt(Dt(o2), function(t3) {
              i2[t3] = n2(o2[t3]);
            }), t2.pop(), e2.pop(), i2;
          }
          return o2;
      ...
      var Dt = Object.keys || function(t2) {
        var e2 = [];
        for (var n2 in t2)
          e2.push(n2);
        return e2;
      ...
      jt(Dt(Ft.prototype), function(t2) {
        Pt[t2] = function(e2) {
        ...
        e2 = function(t3, e3) {
          return e3.modes = h, e3.getFeatureIdsAt = function(e4) {
            ...
            var n3 = JSON.parse(JSON.stringify(It(e4))).features.map(function(e5) {
              if (e5.id = e5.id || D(), null === e5.geometry)
              ...
              if (void 0 === t3.store.get(e5.id) || t3.store.get(e5.id).type !== e5.geometry.type) {
                ...
                r2.properties = e5.properties, he(r2.getCoordinates(), e5.geometry.coordinates) || r2.incomingCoords(e5.geometry.coordinates);
              }
              return e5.id;
            });
...
export default require_maplibre_gl_draw();
//# sourceMappingURL=@hyvilo_maplibre-gl-draw.js.map
