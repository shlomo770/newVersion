...
/* ------------------------------------------------------------------ */
/*  Generic map label defaults (entity labels, JSON path labels)        */
/* ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ */
/*  JSON path import (imported track / route overlays)                  */
/* ------------------------------------------------------------------ */

export const JSON_PATH_VISUALS = {
  line: {
    color: '#22c55e',
    width: 4,
  } as const,
