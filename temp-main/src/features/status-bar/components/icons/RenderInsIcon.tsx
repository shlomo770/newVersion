...
export interface RenderInsIconProps {
  status: InsStatusE;
}

function RenderInsIcon({ status = InsStatusE.NO_COMM }: RenderInsIconProps) {
  const colorClass = insIconClass(status);
  ...
  return (
    <div className={styles.iconWrap}>
      ...
      >
        ...
        <path d="M512 238.344v35.312a8.857 8.857 0 0 1-8.828 8.828H457.27c-12.063 91.067-83.72 162.723-174.786 174.786v45.902a8.857 8.857 0 0 1-8.828 8.828H256V406.07c82.879 0 150.07-67.191 150.07-150.07S338.88 105.93 256 105.93V0h17.656a8.857 8.857 0 0 1 8.828 8.828V54.73c91.067 12.063 162.723 83.72 174.786 174.786h45.902a8.857 8.857 0 0 1 8.828 8.828zm0 0" />
        <path d="M326.621 256A70.605 70.605 0 0 1 256 326.621V185.38A70.605 70.605 0 0 1 326.621 256zm0 0" />
      </svg>
