  ...
  return (
    <>
      <select
        ...
        aria-label={he.statusBar.missionSelectAria}
      >
        <option value="">{he.statusBar.allEntities}</option>
      ...
      <span className={styles.missionLabel}>{he.statusBar.missionLabel}</span>
    </>
  );
}
